...
function LoginPage() {
  ...
  const handle = async () => {
    ...
    try {
      ...
      // onAuthStateChanged dans App prend le relai automatiquement
    } catch (e) {
      const msgs = {
  ...
  return (
    <div className="login-wrap">
      {/* WARN FIX : role="main" déplacé sur div, login-box est un article sémantique */}
      <main>
        <div className="login-box" aria-label="Connexion">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            {/* WARN FIX : htmlFor + id liés pour accessibilité et gestionnaires de MDP */}
