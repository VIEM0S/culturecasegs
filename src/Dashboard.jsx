                              ...
                              <td>
                                <div style={{ display: "flex", gap: 6 }}>
                                  <button
                                    ...
                                    onClick={() => openEdit(p)} aria-label={`Modifier ${p.model} — ${p.design}`}
                                  >
                                    <Icon name="edit" size={12} />
                                  </button>
                                  <button
                                    className="btn btn-danger btn-sm btn-icon"
                                    onClick={() => onDelete(p.id)} aria-label={`Supprimer ${p.model} — ${p.design}`}
                                  >
                                  ...
                                  <button
                                    ...
                                    style={{ fontSize: 11 }}
                                    onClick={() => handleQuickSale(p)} aria-label={`Vente rapide ${p.model} — ${p.design}`}
                                    disabled={p.stock === 0} title={p.stock === 0 ? "Rupture de stock" : `Enregistrer une vente rapide`}
                                  >
                                    ⚡ Vente
                                  </button>
                                </div>
