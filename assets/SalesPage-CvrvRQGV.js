import{r as h,u as Y,t as $e,j as e,I as O,f as c,b as H,g as we,a as he,s as ie}from"./index-D-M55FnN.js";import{M as ce,F as re}from"./components-DHFSQwNR.js";import"./firebase-BFpL2mxF.js";function Ce({sales:v,productMap:R,onClose:D}){var $,A,F,Z,M,J;const[_,q]=h.useState(!1),z=(($=v[0])==null?void 0:$.date)||he(),b=((A=v[0])==null?void 0:A.client)||"",x=((F=v[0])==null?void 0:F.phone)||"",S=((Z=v[0])==null?void 0:Z.quartier)||"",V=((M=v[0])==null?void 0:M.delivery)||!1,w=((J=v[0])==null?void 0:J.remarque)||"",E=v.reduce((o,i)=>o+(i.totalAfterDiscount??i.total),0),C=v.reduce((o,i)=>o+(i.discountAmount||0),0);v.reduce((o,i)=>o+i.total,0);const f=()=>{const o=["🧾 *CULTURECASE GS — Ticket de caisse*",`📅 Date : ${H(z)}`,"","*Produit(s) :*",...v.map(m=>{const k=R[m.productId],P=k?`${k.model} — ${k.design}`:"—",p=m.discountPercent>0?` _(remise ${m.discountPercent}%)_`:"",j=m.discountPercent>0&&m.discountReason?` — _Motif : ${m.discountReason}_`:"";return`• ${P} × ${m.qty} → *${c(m.totalAfterDiscount??m.total)}*${p}${j}`}),"",C>0?`💸 Remise totale : -${c(C)}`:null,`✅ *Total payé : ${c(E)}*`,"",b?`👤 Client : ${b}`:null,x?`📞 Tél : ${x}`:null,S?`📍 Quartier : ${S}`:null,V?"🚚 *Livraison à domicile*":null,w?`📝 Remarque : ${w}`:null,"","_Merci pour votre achat ! 🙏_"].filter(m=>m!==null).join(`
